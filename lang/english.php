...
$strings['BackgroundHorizontal'] = "Background horizontal";
$strings['BackgroundHorizontalHelp'] = "The image must be 1123 x 794 pixels, in PNG format";
$strings['BackgroundVertical'] = "Background vertical";
$strings['Background'] = "Background";
$strings['BackgroundVerticalHelp'] = "The image must have a measurement of 794 x 1123 pixels, in PNG format";
...
$strings ['FrontContentCertificate'] = "Put the content of the front of the certificate here.";
$strings ['PostContentCertificate'] = "Put the contents of the back of the certificate here.";
$strings ['ShowBack'] = "Show later";
$strings ['ShowBackHelp'] = "This option allows showing the back if it is activated.";
$strings ['FrontContent'] = "Front Content";
$strings ['BackContent'] = "Post content";
$strings ['DateSession'] = "Session Date";
$strings ['UseDateViewSession'] = "Use session view date";
$strings ['UseDateAccessSession'] = "Use date of access session";
$strings ['Centimeters'] = "Centimeters";
$strings ['MarginTop'] = "Top margin";
$strings ['MarginBottom'] = "Bottom margin";
$strings['CertificateInformation'] = "Certificate information per student";
$strings['studentName'] = "Student name";
$strings['courseName'] = "Program name";
$strings['datePrint'] = "Printing date";
$strings['scoreCertificate'] = "Outcome";
$strings['codeCertificate'] = "Certificate code";
$strings['NoCertificate'] = "No certificate";
$strings['EmailNotifications'] = "Email notifications";
$strings['ApprovedEmailSubject'] = "Subject for approved students";
$strings['ApprovedEmailContent'] = "Content for approved students";
$strings['FailedEmailSubject'] = "Subject for failed students";
$strings['FailedEmailContent'] = "Content for failed students";
$strings['SendNotificationsToAllStudents'] = "Send results by email to all students";
$strings['EmailTagsHelp'] = "You can use the following tags in the subject and content: ((user_firstname)), ((user_lastname)), ((course_title)), ((certificate_link)), ((certificate_link_html))";
$strings['DirectLinkCertificate'] = "Direct link to certificate";
$strings['TotalApproved'] = "Total approved";
$strings['TotalFailed'] = "Total failed";
$strings['Processing'] = "Processing...";
$strings['Completed'] = "Completed";
$strings['NotificationCertificateSubject'] = "Certificate available";
$strings['NotificationCertificateTemplate'] = "Dear ((user_firstname)), your certificate for the course ((course_title)) is now available. You can download it here: ((certificate_link))";
$strings['NotificationFailedTemplate'] = "Dear ((user_firstname)), we regret to inform you that you have not reached the minimum score for the course ((course_title)).";
$strings['SendResults'] = "Send results";
$strings['ResultsSent'] = "Results sent successfully";
$strings['DownloadCertificate'] = "Download Certificate";
$strings['ApprovedEmailSubjectDefault'] = "Congratulations! Your certificate is ready";
$strings['ApprovedEmailContentDefault'] = "Dear %s, we are pleased to inform you that you have successfully passed the course <strong>%s</strong>. Your certificate is now available for download.";
$strings['FailedEmailSubjectDefault'] = "Evaluation result";
$strings['FailedEmailContentDefault'] = "Dear %s, we inform you that you have not reached the minimum score required for the course <strong>%s</strong>. We encourage you to keep trying.";
$strings['ResultsSent'] = "Results sent successfully";
